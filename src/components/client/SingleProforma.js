...
const SingleProforma = (props) => {
  ...
  const items = useSelector(
    (state) => state.client.proformaItem.proformaItems
  );
            ...
            {myprofroma !== undefined ? (
              <List className={classes.listItem}>
                <ListItem>
                  ...
                  <ListItemText
                    primary={myprofroma.client.names}
                  />
                </ListItem>
                <ListItem>
                  <ListItemText primary="Phone" />
                  <ListItemText
                    primary={myprofroma.client.phoneNumber}
                  />
                </ListItem>
                <ListItem>
                  <ListItemText primary="Email" />
                  <ListItemText
                    primary={myprofroma.client.email}
                  />
                </ListItem>
