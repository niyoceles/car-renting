...
import logo from '../assets/images/Godiscover.png';
...
function Copyright() {
	return (
		<Typography variant='body2' color='textPrimary' align='center'>
			...
			<Link color='inherit' href='https://Bookme.rw.com/'>
				Bookme.rw
			</Link>{' '}
			{'All Rights Reserved.'}
		</Typography>
...
const Footer = () => {
	...
	const social = [
		{
			name: 'Facebook',
			url: 'https://www.facebook.com/bookme.rw',
		},
		{
			name: 'Instagram',
			url: 'https://www.instagram.com/Bookme.rw/',
		},
		{
			name: 'Twitter',
			url: 'https://twitter.com/Bookme.rw',
		},
	];
