...
export default function LandingPage() {
	...
	const selfDrivings = useSelector(
		state => state.client.homeItems.selfdriving
	);

	const carhireItems = useSelector(state => state.client.homeItems.carhire);
	const carhiredriverItems = useSelector(
		state => state.client.homeItems.carhiredriver
	);
		...
		<ClientLayout>
				...
				<Container className={classes.topCardGrid} maxWidth='lg'>
					<Grid container spacing={2}>
						...
						<Grid item xs={12} sm={6} md={3}>
							...
							<Card className={classes.topCard}>
								<ReactLink to='/selfdriving' className={classes.links}>
									<CardMedia
										className={classes.cardLink}
										image={materials}
										title='Self driving'
			...
			<Container className={classes.cardGrid} maxWidth='lg'>
				...
				<Grid container spacing={4}>
					{selfDrivings !== undefined ? (
						selfDrivings.map(card => (
			...
			<Container className={classes.cardGrid} maxWidth='lg'>
				...
				<Grid container spacing={4}>
					{carhireItems !== undefined ? (
						carhireItems.map(card => (
			...
			<Container className={classes.cardGrid} maxWidth='lg'>
				...
				<Grid container spacing={4}>
					{carhiredriverItems !== undefined ? (
						carhiredriverItems.map(card => (
							<Grid item key={card} xs={12} sm={6} md={3}>
								<Card className={classes.card} elevation={3}>
									<ReactLink to={`/view/${card.id}`} className={classes.links}>
										<CardMedia
