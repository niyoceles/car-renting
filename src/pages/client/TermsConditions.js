...
const terms = [
	{
		id: 1,
		title:
			'To use Car rent, you will be required to provide us with personal information of which you have to always keep confidential for your information’s security sake. In case you get worried about your information’s security, kindly alert us right away.',
	},
	{
		id: 2,
		title:
							...
							<Card className={classes.card} elevation={2}>
								<CardContent className={classes.cardContent}>
									...
									<Typography
										...
										component='h2'
									>
									 as either a buyer or a seller, you agree
